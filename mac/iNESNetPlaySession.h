#ifndef __INES_NETPLAY_SESSION_H__
#define __INES_NETPLAY_SESSION_H__
 ...
 * @param ip        服务端地址, 客户端使用; 服务端传 NULL 即可
 ...
 *
 * @param msg 输出当前提示文本(失败时为错误原因), 可为 NULL
 * @param len msg 缓冲区长度
